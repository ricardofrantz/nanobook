...
class IbkrBroker:
    ...
    def submit_order(self, symbol: str, side: str, quantity: int, order_type: str = "market", limit_price_cents: Optional[int] = None, client_order_id: Optional[str] = None) -> int: ...
...
def py_drawdown_series(equity: List[float]) -> List[Dict[str, Any]]: ...
def py_rolling_max_drawdown(equity: List[float], window: int) -> List[float]: ...
...
def py_decompose_backtest(weight_schedule: List[List[Tuple[str, float]]], return_schedule: List[List[Tuple[str, float]]]) -> Dict[str, Any]: ...
def py_tear_sheet(backtest_result: Dict[str, Any], rolling_window: int = 63, periods_per_year: int = 252) -> Dict[str, Any]: ...

# v0.8 — Technical indicators (ta-lib replacements)
def py_sma(close: List[float], period: int) -> List[float]: ...
def py_ema(close: List[float], period: int) -> List[float]: ...
...
def py_bollinger(close: List[float], period: int, num_std_up: float, num_std_dn: float) -> Tuple[List[float], List[float], List[float]]: ...
def py_atr(high: List[float], low: List[float], close: List[float], period: int) -> List[float]: ...
def py_wilder_atr(high: List[float], low: List[float], close: List[float], period: int) -> List[float]: ...
...
def py_walkforward(returns: List[float], params: Optional[List[float]] = None, n_windows: int = 5, train_pct: float = 0.7, periods_per_year: float = 252.0, risk_free: float = 0.0) -> List[Dict[str, Any]]: ...
...
def py_realized_vol(open: List[float], high: List[float], low: List[float], close: List[float], method: str = "close_to_close") -> float: ...

# v0.9 — Capability probing and advanced compute APIs
def py_capabilities() -> List[str]: ...
def py_garch_ewma_forecast(returns: List[float], p: int = 1, q: int = 1, mean: str = "zero") -> float: ...
...
def py_inverse_cvar_weights(returns_matrix: List[List[float]], symbols: List[str], alpha: float = 0.95) -> Dict[str, float]: ...
def py_inverse_cdar_weights(returns_matrix: List[List[float]], symbols: List[str], alpha: float = 0.95) -> Dict[str, float]: ...
def py_optimize_hrp(returns_matrix: List[List[float]], symbols: List[str]) -> Dict[str, float]: ...
...
def decompose_backtest(weight_schedule: List[List[Tuple[str, float]]], return_schedule: List[List[Tuple[str, float]]]) -> Dict[str, Any]: ...
def tear_sheet(backtest_result: Dict[str, Any], rolling_window: int = 63, periods_per_year: int = 252) -> Dict[str, Any]: ...
...
def macd(close: List[float], fast_period: int = 12, slow_period: int = 26, signal_period: int = 9) -> Tuple[List[float], List[float], List[float]]: ...
def bollinger(close: List[float], period: int = 20, num_std_up: float = 2.0, num_std_dn: float = 2.0) -> Tuple[List[float], List[float], List[float]]: ...
def wilder_atr(high: List[float], low: List[float], close: List[float], period: int = 14) -> List[float]: ...
def realized_vol(open: List[float], high: List[float], low: List[float], close: List[float], method: str = "close_to_close") -> float: ...
def drawdown_series(equity: List[float]) -> List[Dict[str, Any]]: ...
def rolling_max_drawdown(equity: List[float], window: int) -> List[float]: ...
def walkforward(returns: List[float], params: Optional[List[float]] = None, n_windows: int = 5, train_pct: float = 0.7, periods_per_year: float = 252.0, risk_free: float = 0.0) -> List[Dict[str, Any]]: ...
def garch_ewma_forecast(returns: List[float], p: int = 1, q: int = 1, mean: str = "zero") -> float: ...
